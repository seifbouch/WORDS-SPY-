...
public static class GameEvents 
{
   ...
   public delegate void UnlockedNextCategory(); 
    public static event UnlockedNextCategory OnUnlockedNextCategory ; 
    public static void UnlockedNextCategoryMethod ()
    {
        if ( OnUnlockedNextCategory != null)
        {
            OnUnlockedNextCategory() ; 
        }
    } 
    ...
    public static event LoadNextLevel OngameOver ; 
